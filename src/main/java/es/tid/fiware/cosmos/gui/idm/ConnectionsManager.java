 ...
 * 
 * This is a convenience class in order the clients do not have to import stuff
 * from org.apache.http. Thus, by just importing this "live_demo_interfaces"
 * library, the clients have all they need.
 * 
 */
public class ConnectionsManager {
     ...
     */
    public ConnectionsManager(boolean ssl) {
        // create the logger
        logger = Logger.getLogger(ConnectionsManager.class);
